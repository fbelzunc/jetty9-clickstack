...
jetty_ver = 9.0.5.v20130815
jetty_url = http://repo1.maven.org/maven2/org/eclipse/jetty/jetty-distribution/$(jetty_ver)/jetty-distribution-$(jetty_ver).zip
jetty_md5 = 7a7a6b1d7fed2d051531b8f27b75259a
